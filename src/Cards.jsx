  ...
  useEffect(() => {
    async function getCatImageUrls() {
      const img = await fetch(
        "https://api.thecatapi.com/v1/images/search?limit=12&size=med&mime_types=jpg&order=RANDOM&api_key=live_4xcACum8Qf3UMhr8O4Dw9kd0m8mush3bifrpN3Bk5ndOoHdJO7u7jRmvjuEsIgMD"
      );
